...
$works = [
	[
		"name" => "Good cat",
		"dateStart" => "Marth 2020",
		"dateEnd" => "Now",
		"description" => "I like food and sleep",
	],
	[
		"name" => "Young cat",
		"dateStart" => "May 2018",
		"dateEnd" => "Marth 2020",
		"description" => "I like RUN",
	],
	[
		"name" => "Little cat",
		"dateStart" => "February 2018",
		"dateEnd" => "May 2018",
		"description" => "I like sleep and mimimi",
	],
];
?>
<!DOCTYPE html>
        ...
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <div class="w3-container">
            ...
            <h6 class="w3-text-teal">
            	...
            	<?php echo $works[$i]['dateStart']; ?> - <span class="w3-tag w3-teal w3-round">	<?php echo $works[$i]['dateEnd']; ?></span>
            </h6>
